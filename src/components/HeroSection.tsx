...
const HeroSection = () => {
  ...
  return (
    <section id="home" ref={ref} className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="relative container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-3xl">
          ...
          >
            THINK Acquisition delivers expert acquisition support, program management, 
            and technical consulting services to federal agencies and defense organizations.
          </motion.p>
